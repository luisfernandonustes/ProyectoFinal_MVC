...
namespace ProyectoFinal_MVC.Data
{
    ...
    {
        private readonly ProyectoFinal_MVCDbContext context;
        public Repository(ProyectoFinal_MVCDbContext context)
        {
        ...
        public  async Task<T> Getobj<T>(Guid id) where T : Entity
        {
